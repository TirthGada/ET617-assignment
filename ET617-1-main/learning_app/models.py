...
class PollOption(models.Model):
    ...
    def __str__(self):
        return f"{self.poll.title} - Option {self.order}"
...
class PollResponse(models.Model):
    ...
    rating_value = models.IntegerField(null=True, blank=True, help_text="For rating scale polls")
    submitted_at = models.DateTimeField(auto_now_add=True)
    ip_address = models.GenericIPAddressField()
    
    class Meta:
        unique_together = ['poll', 'ip_address']  # Prevent duplicate responses unless allowed
    
    def __str__(self):
        return f"{self.student_name or 'Anonymous'} - {self.poll.title}"
...
class PollAnalytics(models.Model):
    ...
    average_rating = models.FloatField(null=True, blank=True, help_text="For rating polls")
